...
import { requireLevel, requireRead, requireUpdate, authenticate } from '../middleware/auth.js';
...
router.get('/profile', requireLevel(1), (req, res) => authController.getProfile(req, res));
